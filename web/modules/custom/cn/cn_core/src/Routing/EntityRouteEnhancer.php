...
use Drupal\Core\Entity\Enhancer\EntityRouteEnhancer as Base;

/**
 * Enhances an entity form route with the appropriate controller.
 */
class EntityRouteEnhancer extends Base implements EnhancerInterface {
  ...
  protected function enhanceEntityView(array $defaults, Request $request) {
    $defaults['_controller'] = '\Drupal\cn_core\Controller\EntityViewController::view';
