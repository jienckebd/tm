...
use Drupal\cn_feeds\Feeds\Reader\Feed\Article as ArticleFeed;
use Drupal\cn_feeds\Feeds\Reader\Entry\Article as ArticleEntry;
use Zend\Feed\Reader\Extension\Podcast\Entry as ZendPodcastEntry;

/**
 */
class ArticleReader extends Base {
  ...
  public static function importString($string)
  {
    ...
    if (substr($type, 0, 3) == 'rss') {
      $reader = new ArticleFeed($dom, $type);
