...
namespace Drupal\cn_feeds\Feeds\Fetcher;
 ...
 * @FeedsFetcher(
 *   id = "itunes",
 *   title = @Translation("Itunes"),
 *   description = @Translation("Download itunes podcasts."),
 *   form = {
 ...
 * )
 */
class Itunes extends PluginBase implements ClearableInterface, FetcherInterface {
