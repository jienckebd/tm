...
/**
 * The base plugin to handle attribute matching.
 */
abstract class Base extends ComponentPluginBase implements MatcherInterface {
   ...
   * {inheritdoc}.
   */
  abstract function matchEntity(AttributeInterface $attribute_entity, EntityInterface $target_entity, EntityInterface $entity);
