...
(function ($, Drupal, drupalSettings) {
  ...
  // Hello World.
  Drupal.behaviors.tm_theme_alpha_contextual = {
  ...
  // Hello World.
  Drupal.behaviors.tm_theme_alpha_ajax = {
    attach: function (context) {
  ...
  // Hello World.
  Drupal.behaviors.tm_theme_alpha_header = {
    attach: function (context) {

      $('.sticky-scroll--inner--form form').addClass('sticky-scroll');
